      ...
      >
        <div className="w-[22rem] lg:w-[30rem] bg-slate-900/40 rounded-lg p-2 flex flex-col items-center justify-center gap-4">
          <Image
            ...
            className="scale-95 aspect-square hover:scale-100 hover:rounded-lg cursor-pointer transition-all duration-500 ease-in object-cover grayscale hover:grayscale-0"
            width={2000}
            height={2000}
            priority
          />
