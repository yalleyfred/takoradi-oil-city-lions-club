...
export default function WhatWeDo() {
  return (
    <section className="py-24 px-4 flex  items-center bg-slate-100 justify-start gap-16 my-10 ">
      <div className="w-6xl mx-auto flex flex-col lg:flex-row-reverse items-center gap-10 justify-start">
        <div className="flex-col">
          ...
          <div className="flex flex-col gap-4 mt-4">
            {services.slice(0, 4).map((service) => (
              <div key={service.id} className="flex items-center gap-1 py-2">
                <Service
                  title={service.title}
        ...
        {/* image Container */}
        <div className="flex items-center w-full lg:w-[40rem] lg:h-[35rem] bg-slate-800/40 rounded-lg">
          <Image
